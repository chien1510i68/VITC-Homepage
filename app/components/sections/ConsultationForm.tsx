...
export default function ConsultationForm({ isSubSection = false }: { isSubSection?: boolean }) {
  ...
  const formContent = (
    <div className={isSubSection ? "" : "container mx-auto px-4 sm:px-6 lg:px-8"}>
      <Card className={isSubSection ? "w-full" : "max-w-2xl mx-auto"}>
        <CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent ${errors.program ? 'border-red-300 bg-red-50' : 'border-gray-300'
                  }`}
                required
  ...
  if (isSubSection) return formContent;
