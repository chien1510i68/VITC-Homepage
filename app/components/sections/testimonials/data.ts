...
export const testimonials: Testimonial[] = [
  {
    ...
    quote: "Sau khi học tại VISC, tôi đã có thể sử dụng thành thạo Excel và Word. Giảng viên rất tận tình hướng dẫn.",
    rating: 5
  },
  {
    id: 2,
  ...
  },
  {
    ...
    quote: "Khóa học thiết kế tại VISC giúp tôi nắm vững Photoshop và Illustrator. Hiện tại tôi đã có công việc ổn định.",
    rating: 4
  },
  {
    id: 4,
  ...
  },
  {
    ...
    quote: "VISC cung cấp kiến thức toàn diện về công nghệ thông tin. Tôi đã học được rất nhiều điều bổ ích cho công việc.",
    rating: 4
  },
  {
    id: 6,
    ...
    quote: "Học phí hợp lý, chất lượng đào tạo cao. Tôi rất hài lòng với khóa học tại VISC và sẽ giới thiệu bạn bè đến học.",
    rating: 5
  }
];