...
function getFallbackImage(type: 'announcement' | 'news'): string {
...
function getSafeImageUrl(url: string | undefined | null, type: 'announcement' | 'news'): string {
...
function ImageWithFallback({ src, alt, fill, className, fallbackSrc }: ImageWithFallbackProps) {
...
export default function NewsSection() {
  ...
  if (isLoading) {
    return (
      <section id="news" className="py-16 bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Cập nhật tin tức và thông báo mới nhất về Tin học
          </p>
        </div>
