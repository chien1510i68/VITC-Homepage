...
export default function TaiLieuSection() {
  ...
  const handlePageChange = (page: number) => {
    setCurrentPage(page);
    const section = document.getElementById('tai-lieu');
    if (section) {
  ...
  return (
    <section id="tai-lieu" className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 border border-green-200 mb-4">
            ...
            <span className="text-sm font-semibold text-green-700">Tài liệu học tập</span>
          </div>
        ...
        <div className="mb-10 max-w-4xl mx-auto">
          ...
          <div className="relative mb-6">
            <input
              ...
              placeholder="Tìm kiếm tài liệu, slide, video..."
              className="w-full pl-14 pr-4 py-3 text-base border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all shadow-sm hover:border-green-300"
            />
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-gray-600">
            ...
            <span>
              <span className="font-semibold text-gray-900">{searchQuery ? filteredDocuments.length : total}</span> tài liệu
              {searchQuery && <span className="text-gray-400 ml-1">phù hợp</span>}
            </span>
          </div>
        </div>
