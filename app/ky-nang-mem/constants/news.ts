...
export const NEWS_CATEGORIES = [
  { id: 'all', label: 'Tất cả', count: SAMPLE_NEWS.length },
  { id: 'certificate', label: 'Danh sách cấp chứng chỉ', count: 3 },
  { id: 'announcement', label: 'Thông báo chung', count: 4 },
  { id: 'event', label: 'Sự kiện', count: 2 }
] as const;
