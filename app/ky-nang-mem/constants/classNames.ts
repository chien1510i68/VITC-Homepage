...
export const SECTION_PADDING = 'py-16 lg:py-24';
export const SECTION_PADDING_LG = 'py-20 lg:py-32';

export const CONTAINER_BASE = 'container mx-auto px-6 sm:px-8 lg:px-12';
...
export const HEADING_1 = 'text-4xl lg:text-5xl font-black leading-tight tracking-tight text-slate-900';
export const HEADING_2 = 'text-3xl lg:text-4xl font-bold text-slate-900';
export const HEADING_3 = 'text-2xl lg:text-3xl font-bold text-slate-900';
export const HEADING_4 = 'text-xl lg:text-2xl font-semibold text-slate-900';

export const TEXT_BODY = 'text-base text-slate-700 leading-relaxed';
export const TEXT_SUBTITLE = 'text-lg text-slate-600 leading-relaxed';
...
export const CARD_BASE = 'bg-white rounded-3xl shadow-md border border-slate-100';
...
export const GRID_2 = 'grid grid-cols-1 sm:grid-cols-2 gap-6';
export const GRID_3 = 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6';
export const GRID_4 = 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6';
